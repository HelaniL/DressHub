...
public class ViewProducts extends AppCompatActivity {
    ...
    class MyAdapter extends ArrayAdapter<Products> {
        ...
        public View getView(int position, View view, ViewGroup parent) {
            ...
            holder.COL3.setText(user.get(position).getMatireal());
            holder.COL4.setText(user.get(position).getStreachable());
            holder.COL5.setText(user.get(position).getSize());
            holder.COL6.setText(user.get(position).getPrize());
